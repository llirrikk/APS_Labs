...
4. Проверить с помощью тестового окружения корректность их работы (пример [`тестового окружения`](https://github.com/MPSU/APS/blob/technical/Other/Testbench.md))
...
![ОЗУ и ПЗУ](/media/labs/ram_rom.png)
...
![Память инструкций](/media/labs/im.png)
...
![Регистровый файл](/media/labs/rf.png)
